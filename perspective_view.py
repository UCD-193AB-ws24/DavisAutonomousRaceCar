...
def main():
    ...
    # -------------------------------------------------------
    mask_path = "test1.png"  # Update with your correct path
    ...
    tl = (220, 270)  # Top-left
    bl = (0,   450)  # Bottom-left
    tr = (380, 270)  # Top-right
    br = (640, 450)  # Bottom-right
    ...
    pts2 = np.float32([
        [100,  0],   # New top-left
        [160,  480], # New bottom-left
        [540,  0],   # New top-right
        [540,  480]  # New bottom-right
    ])
